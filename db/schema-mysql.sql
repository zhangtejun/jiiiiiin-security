...
# Database: vplusdb
# Generation Time: 2018-12-05 09:44:59 +0000
# ************************************************************
...
VALUES
	(141,1061277220292595713,1062518178556526593),
	(142,1061277220292595713,1066671419766624257),
	(143,1061277220292595713,1061818316563202049);
...
CREATE TABLE `mng_role_resource_for_eleui` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `role_id` bigint(20) NOT NULL COMMENT '角色主键',
  `resource_ids` varchar(255) NOT NULL COMMENT 'element-ui tree选中的资源ids',
  PRIMARY KEY (`id`)
