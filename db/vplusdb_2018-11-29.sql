...
# Database: vplusdb
# Generation Time: 2018-11-29 08:43:28 +0000
# ************************************************************
...
INSERT INTO `mng_admin` (`id`, `create_time`, `username`, `password`, `phone`, `email`)
VALUES
	(1,'2018-11-10 23:12:02','admin','$2a$10$XQi3SDI8aU8VL8PQkkyddOYk62OmDBtLwD9f9EEKf0AZBI0Y7pwPq','15399999999','15399999999@163.com');
...
INSERT INTO `mng_resource` (`id`, `pid`, `pids`, `name`, `icon`, `url`, `method`, `num`, `levels`, `type`, `status`, `isopen`, `channel`, `path`)
VALUES
	(1061818316563202049,0,'0','权限管理','cog','','',2,1,1,1,0,0,'/mngauth'),
	(1061818318412890114,1061818316563202049,'0,1061818316563202049','操作员管理','users','admin','GET',1,2,1,1,0,0,'/mngauth/admin'),
	(1061818318463221761,1061818316563202049,'0,1061818316563202049','角色管理','id-badge','role','GET',2,2,1,1,0,0,'/mngauth/role'),
	(1061818318517747714,1061818316563202049,'0,1061818316563202049','资源管理','tree','resource','GET',3,2,1,1,0,0,'/mngauth/resource'),
	(1061993676089069570,1061818318517747714,'0,1061818316563202049,1061818318517747714','新增资源',NULL,'resource','POST',2,3,0,1,0,0,NULL),
	(1062518178556526593,0,'0','首页','home','','GET',1,1,1,1,0,0,'/index'),
	(1062546326157291522,1061818318517747714,'0,1061818316563202049,1061818318517747714','修改资源',NULL,'resource','UPDATE',3,3,0,1,0,0,NULL),
	(1065904215529881601,1061818318517747714,'0,1061818316563202049,1061818318517747714','删除资源','','resource','DELETE',1,3,0,1,0,0,''),
	(1066671419766624257,0,'0','系统设置','calendar-check-o','','',3,1,1,1,0,0,'/mngsys'),
	(1067715924141809665,1067713955255820290,'0,1066671419766624257,1067713955255820290','test4','','','',1,3,1,1,0,0,'');
...
INSERT INTO `mng_role` (`id`, `pid`, `name`, `authority_name`, `num`)
VALUES
	(1061277220292595713,0,'系统管理员','ADMIN',0),
	(1061277221798350849,1061277220292595713,'数据库管理员','DB_ADMIN',0),
	(1061277221831905282,1061277220292595713,'部门操作员','OPERATOR',1);
...
VALUES
	(10,1061277220292595713,1061818318463221761),
	(11,1061277220292595713,1061818318517747714),
	(12,1061277220292595713,1061818316563202049),
	(13,1061277220292595713,1061818318412890114),
	(18,1061277220292595713,1061993676089069570),
	(21,1061277220292595713,1062546326157291522);
