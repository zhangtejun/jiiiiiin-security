...
public class DemoUserDetailsService implements UserDetailsService, SocialUserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		return new User(username, passwordEncoder.encode("a11111"), AuthorityUtils.commaSeparatedStringToAuthorityList("admin"));
	}

	@Override
	public SocialUserDetails loadUserByUserId(String userId) throws UsernameNotFoundException {
		L.info("设计登录用户Id:" + userId);
